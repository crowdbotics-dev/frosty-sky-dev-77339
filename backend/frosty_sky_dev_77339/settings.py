"""
Django settings for frosty_sky_dev_77339 project.
...
ROOT_URLCONF = 'frosty_sky_dev_77339.urls'
...
WSGI_APPLICATION = 'frosty_sky_dev_77339.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_sky_dev_77339 API",
    "DESCRIPTION": "API documentation for frosty_sky_dev_77339 App",
    "VERSION": "v1",
}
